...
function loadAllScripts() {
    ...
    chrome.runtime.sendMessage({
        ...
        if (e && e.scripts) {
            ...
            renderScriptsList(e.scripts);
        } else if (e && e.error) {
            console.error("loadAllScripts: Error received from background:", e.error);
            showStatusMessage("Error loading scripts: " + e.error, true);
        } else {
            console.error("loadAllScripts: No scripts or unexpected response from background:", e);
