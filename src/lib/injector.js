function injectScript(e,t){t=`
    ...
    `;chrome.scripting.executeScript({target:{tabId:e},func:new Function(t),world:"MAIN"}).catch(t=>{console.error(`Error injecting script into tab ${e}:`,t)})}export{injectScript};